...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private float widthRatio = 0.68f;//扫码框宽度占view总宽度的比例
    ...
    public void drawViewFinderMask(Canvas canvas) {
        ...
        canvas.drawRect(0, framingRect.top, framingRect.left, framingRect.bottom + 1, maskPaint);//扫码框左边阴影
        canvas.drawRect(framingRect.right + 1, framingRect.top, width, framingRect.bottom + 1, maskPaint);//扫码框右边阴影
        canvas.drawRect(0, framingRect.bottom + 1, width, height, maskPaint);//扫码框底部阴影
    }
